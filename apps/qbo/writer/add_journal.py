                    ...
                    for k in range(0, len(QBO_coa)):
                        ...
                        if 'AcctNum' in QBO_coa[k]:
                            if QuerySet1[i]["is_credit_debit"][j]["DisplayID"]== QBO_coa[k]["AcctNum"]:
                                ...
                                break
                            elif QuerySet1[i]["is_credit_debit"][j]["Account_Name"]== QBO_coa[k]["FullyQualifiedName"]:
                                QuerySet5["value"] = QBO_coa[k]["Id"]
                                QuerySet5["name"] = QBO_coa[k]["Name"]
                                break
                        else:
                            if QuerySet1[i]["is_credit_debit"][j]["Account_Name"]== QBO_coa[k]["FullyQualifiedName"]:
                                QuerySet5["value"] = QBO_coa[k]["Id"]
                                QuerySet5["name"] = QBO_coa[k]["Name"]
                                break
