...
def get_combined_bill(data1, all_bill, k, job_id):
    try:
        dbname = get_mongodb_database()
        item_bill = dbname["item_bill"]
        service_bill = dbname["service_bill"]
        misc_bill = dbname["misc_bill"]
        professional_bill = dbname["professional_bill"]
        all_bill = dbname["all_bill"]
        ...
        combined_bill = dbname[f"combined_bill_{k}"]
